...
namespace SocketServer
{
    public class SocketConnection
    {
        ...
        public TextBox txtSocket { get; set; }
        public TextBox txtRecord { get; set; }
        ...
        public void addtxt(TextBox txtSocket,TextBox txtRecord)
        {
        ...
        private void ReceiveCallback(IAsyncResult ar)
        {
            try
            {
                ...
                if (REnd > 0)
                {
                    ...
                    //fr.Controls["txtRecord"].Text += string.Format("客户端{0}传来消息:{1}", ((IPEndPoint)this.clientSocket.RemoteEndPoint).ToString(), str);
                    //fr.Controls["txtRecord"].Text += "\r\n";
                    //Form1 
                    this.txtRecord.Text += string.Format("客户端{0}传来消息:{1}", ((IPEndPoint)this.clientSocket.RemoteEndPoint).ToString(), str);
                    this.txtRecord.Text += "\r\n";
