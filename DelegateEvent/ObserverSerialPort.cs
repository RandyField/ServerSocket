...
namespace DelegateEvent
{
    ...
    /// </summary>
    public class ObserverSerialPort : ObserverBase
    {

        public ObserverSerialPort(ModelBase childModel)
            : base(childModel)
        {
                
        }
        /// <summary>
        /// 覆盖该类观察者需要做出的具体响应行为SendDataToScreenGame
        /// 此行为已在观察者基类中注册与委托时间，由委托时间调度执行，不需要直接调用
        /// </summary>
        public override void Resoponse()
        {
            System.Console.WriteLine("发送单车数据到大屏幕游戏程序中");
